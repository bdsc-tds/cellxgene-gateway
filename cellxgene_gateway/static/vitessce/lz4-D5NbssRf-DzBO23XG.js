import { t as e } from "./chunk-INHXZS53-DiyuLb3Z-G2qR3t2L.js";
//#region node_modules/vitessce/dist/lz4-D5NbssRf.js
var t = Object.defineProperty, n = (e, n, r) => n in e ? t(e, n, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: r
}) : e[n] = r, r = (e, t, r) => n(e, typeof t == "symbol" ? t : t + "", r), i = (typeof document < "u" && document.currentScript && document.currentScript.src, function(e = {}) {
	var t = e, n, r;
	...
	var o;
	t.wasmBinary && (o = t.wasmBinary), typeof WebAssembly != "object" && C("no native wasm support detected");
	...
	var w = (e) => e.startsWith("data:application/octet-stream;base64,"), te = (e) => e.startsWith("file://"), T;
	if (T = "lz4_codec.wasm", !w(T)) {
		var ne = T;
		T = t.locateFile ? t.locateFile(ne, "") : "" + ne;
	}
	function re(e) {
	...
	function ie(e, t, n) {
		return re(e).then((e) => WebAssembly.instantiate(e, t)).then((e) => e).then(n, (e) => {
			a(`failed to asynchronously prepare wasm: ${e}`), C(e);
		});
	}
	function ae(e, t) {
		var n = T;
		return o || typeof WebAssembly.instantiateStreaming != "function" || w(n) || te(n) || typeof fetch != "function" ? ie(n, e, t) : fetch(n, { credentials: "same-origin" }).then((r) => WebAssembly.instantiateStreaming(r, e).then(t, function(r) {
			return a(`wasm streaming compile failed: ${r}`), a("falling back to ArrayBuffer instantiation"), ie(n, e, t);
		}));
	}
	var E = (e) => {
	...
	}, V = (e, t) => Object.defineProperty(t, "name", { value: e }), de = (e) => {
		for (; e.length;) {
			var t = e.pop();
			e.pop()(t);
		}
	...
	var pe = (e, n) => {
		...
		if (t.hasOwnProperty(e)) {
			...
			if (pe(e, e), t.hasOwnProperty(r)) throw new N(`Cannot register multiple overloads of a function with the same number of arguments (${r})!`);
			t[e].A[r] = n;
		...
		e = k(e);
		var n = e.includes("j") ? ge(e, t) : U.get(t);
	...
	for (var K = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0, Se = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, Ce = (e, t) => {
		for (var n = e >> 1, r = n + t / 2; !(n >= r) && f[n];) ++n;
		if (n <<= 1, 32 < n - e && Se) return Se.decode(u.subarray(e, n));
		for (n = "", r = 0; !(r >= t / 2); ++r) {
			var i = d[e + 2 * r >> 1];
			if (i == 0) break;
		...
		return t;
	}, q = Array(256), J = 0; 256 > J; ++J) q[J] = String.fromCharCode(J);
	O = q, N = t.BindingError = class extends Error {
		constructor(e) {
	...
	var ke = {
		...
		d: (e, n, r, i, a, o, s) => {
			var c = he(n, r);
			e = k(e), e = ye(e), a = _e(i, a), me(e, function() {
				ve(`Cannot call ${e} due to unbound types`, c);
			}, n - 1), ce(c, function(r) {
				var i = e, c = e;
        ...
        if (arguments.length !== ${m - 2}) {
          throwBindingError('function ${c} called with ' + arguments.length + ' arguments, expected ${m - 2}');
				...
				let [y, b] = [v, h + "}\n"];
				if (y.push(b), r = fe(y).apply(null, l), c = V(c, r), r = n - 1, !t.hasOwnProperty(i)) throw new P("Replacing nonexistant public symbol");
		...
		b: (e, t, n, r, i) => {
			...
			F(e, {
				...
				toWireType: o,
				argPackAdvance: 8,
				readValueFromPointer: be(t, n, r !== 0),
				C: null
			});
		},
		a: (e, t, n) => {
		...
		c: (e, t, n) => {
			if (n = k(n), t === 2) var r = Ce, i = we, a = Te, o = () => f, s = 1;
			else t === 4 && (r = Ee, i = De, a = Oe, o = () => m, s = 2);
			F(e, {
				name: n,
				fromWireType: (e) => {
		...
		function e(e) {
			return Y = e.exports, s = Y.r, _(), U = Y.w, y.unshift(Y.s), x--, t.monitorRunDependencies?.(x), x == 0 && S && (e = S, S = null, e()), Y;
		}
		var n = { a: ke };
	...
	}(), X = (e) => (X = Y.t)(e), Z = (e) => (Z = Y.u)(e), Ae = (e) => (Ae = Y.v)(e), Q;
	S = function e() {
		Q || $(), Q || (S = e);
	};
	function $() {

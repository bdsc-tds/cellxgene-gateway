import { $a as e, $t as t, A as n, Aa as r, C as i, Cr as a, E as o, Er as s, Fn as c, Fr as l, Ft as u, G as d, Gn as f, Hi as p, Hn as m, In as h, Kn as g, Ln as ee, Mr as _, Or as te, Pr as ne, Qn as v, Sr as re, St as ie, U as y, Un as b, Ur as x, V as ae, Vn as oe, Wr as S, Xi as C, _n as w, a as se, ar as T, br as ce, ca as le, eo as E, er as ue, fn as de, fr as D, gn as fe, gr as pe, ha as me, hr as he, in as ge, ir as _e, j as ve, jn as ye, ka as O, kn as be, mn as xe, no as k, oa as Se, pn as Ce, pr as A, qt as j, rr as M, sn as we, ua as Te, yr as Ee, zr as De } from "./three.core-1aHSpGwp.js";
...
function P(e, t, n) {
	n(e, t);
	for (let r = 0; r < e.children.length; r++) P(e.children[r], t.children[r], n);
}
//#endregion
...
var ke = class extends f {
	constructor(e) {
		super(e), this.dracoLoader = null, this.ktx2Loader = null, this.meshoptDecoder = null, this.pluginCallbacks = [], this.register(function(e) {
			...
			return new L(e, I.EXT_MESHOPT_COMPRESSION);
		}), this.register(function(e) {
			return new L(e, I.KHR_MESHOPT_COMPRESSION);
		}), this.register(function(e) {
			return new qe(e);
		});
	}
	load(e, t, n, r) {
		...
		if (this.resourcePath !== "") a = this.resourcePath;
			...
			let t = g.extractUrlBase(e);
			a = g.resolveURL(t, this.path);
		} else a = g.extractUrlBase(e);
		this.manager.itemStart(e);
		let o = function(t) {
			r ? r(t) : console.error(t), i.manager.itemError(e), i.manager.itemEnd(e);
		}, s = new u(this.manager);
	...
	parse(e, t, n, r) {
		...
		else if (e instanceof ArrayBuffer) if (s.decode(new Uint8Array(e, 0, 4)) === R) {
			try {
				a[I.KHR_BINARY_GLTF] = new Je(e);
			} catch (e) {
				r && r(e);
				return;
			}
			i = JSON.parse(a[I.KHR_BINARY_GLTF].content);
...
var I = {
	...
	_loadLight(e) {
		...
		switch (a.type) {
			case "directional":
				o = new ie(s), o.target.position.set(0, 0, -1), o.add(o.target);
				break;
			case "point":
				o = new _(s), o.distance = c;
				break;
			case "spot":
				o = new me(s), o.distance = c, a.spot = a.spot || {}, a.spot.innerConeAngle = a.spot.innerConeAngle === void 0 ? 0 : a.spot.innerConeAngle, a.spot.outerConeAngle = a.spot.outerConeAngle === void 0 ? Math.PI / 4 : a.spot.outerConeAngle, o.angle = a.spot.outerConeAngle, o.penumbra = 1 - a.spot.innerConeAngle / a.spot.outerConeAngle, o.target.position.set(0, 0, -1), o.add(o.target);
				break;
			default: throw Error("THREE.GLTFLoader: Unexpected light type: " + a.type);
		}
		return o.position.set(0, 0, 0), X(o, a), a.intensity !== void 0 && (o.intensity = a.intensity), o.name = t.createUniqueName(a.name || "light_" + e), r = Promise.resolve(o), t.cache.add(n, r), r;
	}
	getDependency(e, t) {
	...
	extendParams(e, t, n) {
		...
		if (i) {
			...
			i.baseColorTexture !== void 0 && r.push(n.assignTexture(e, "map", i.baseColorTexture, C));
		}
	...
	extendMaterialParams(e, t) {
		let n = F(this.parser, e, this.name);
	...
	extendMaterialParams(e, t) {
		...
		return n.sheenRoughnessFactor !== void 0 && (t.sheenRoughness = n.sheenRoughnessFactor), n.sheenColorTexture !== void 0 && r.push(this.parser.assignTexture(t, "sheenColorMap", n.sheenColorTexture, C)), n.sheenRoughnessTexture !== void 0 && r.push(this.parser.assignTexture(t, "sheenRoughnessMap", n.sheenRoughnessTexture)), Promise.all(r);
	}
}, Re = class {
	constructor(e) {
	...
	extendMaterialParams(e, t) {
		...
		return t.attenuationColor = new y().setRGB(i[0], i[1], i[2], b), Promise.all(r);
	}
}, Be = class {
	constructor(e) {
	...
	extendMaterialParams(e, t) {
		...
		return t.specularColor = new y().setRGB(i[0], i[1], i[2], b), n.specularColorTexture !== void 0 && r.push(this.parser.assignTexture(t, "specularColorMap", n.specularColorTexture, C)), Promise.all(r);
	}
}, He = class {
	constructor(e) {
	...
	constructor(e) {
		this.parser = e, this.name = I.EXT_TEXTURE_WEBP;
	}
	loadTexture(e) {
	...
	constructor(e) {
		this.parser = e, this.name = I.EXT_TEXTURE_AVIF;
	}
	loadTexture(e) {
		let t = this.name, n = this.parser, r = n.json, i = r.textures[e];
		if (!i.extensions || !i.extensions[t]) return null;
	...
	createNodeMesh(e) {
		...
		for (let e of r.primitives) if (e.mode !== H.TRIANGLES && e.mode !== H.TRIANGLE_STRIP && e.mode !== H.TRIANGLE_FAN && e.mode !== void 0) return null;
		let i = n.extensions[this.name].attributes, o = [], s = {};
		for (let e in i) o.push(this.parser.getDependency("accessor", i[e]).then((t) => (s[e] = t, s[e])));
		return o.length < 1 ? null : (o.push(this.parser.createNodeMesh(e)), Promise.all(o).then((e) => {
			...
			for (let e of n) {
				let t = new M(), n = new E(), o = new x(), c = new E(1, 1, 1), l = new we(e.geometry, e.material, r);
				...
				for (let t in s) if (t === "_COLOR_0") {
					let e = s[t];
					l.instanceColor = new ge(e.array, e.itemSize, e.normalized);
				} else t !== "TRANSLATION" && t !== "ROTATION" && t !== "SCALE" && e.geometry.setAttribute(t, s[t]);
				a.prototype.copy.call(l, e), this.parser.assignFinalMaterial(l), i.push(l);
			}
	...
	constructor(e) {
		...
		let t = new DataView(e, 0, z), n = new TextDecoder();
		if (this.header = {
			magic: n.decode(new Uint8Array(e.slice(0, 4))),
			version: t.getUint32(4, !0),
			length: t.getUint32(8, !0)
		}, this.header.magic !== R) throw Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");
		if (this.header.version < 2) throw Error("THREE.GLTFLoader: Legacy binary file detected.");
		let r = this.header.length - z, i = new DataView(e, z), a = 0;
		for (; a < r;) {
			let t = i.getUint32(a, !0);
			a += 4;
			let r = i.getUint32(a, !0);
			if (a += 4, r === B.JSON) {
				let r = new Uint8Array(e, z + a, t);
	...
	decodePrimitive(e, t) {
		...
		for (let t in e.attributes) {
			...
			if (a[t] !== void 0) {
				...
				c[r] = U[i.componentType].name, s[r] = i.normalized === !0;
			}
		}
	...
	interpolate_(e, t, n, r) {
		let i = this.resultBuffer, a = this.sampleValues, o = this.valueSize, s = o * 2, c = o * 3, l = r - t, u = (n - t) / l, d = u * u, f = d * u, p = e * c, m = p - c, h = -2 * f + 3 * d, g = f - d, ee = 1 - h, _ = g - d + u;
		for (let e = 0; e !== o; e++) {
			let t = a[m + e + o], n = a[m + e + s] * l, r = a[p + e + o], c = a[p + e] * l;
			i[e] = ee * t + _ * n + h * r + g * c;
		}
		return i;
	}
}, Qe = new x(), $e = class extends V {
	interpolate_(e, t, n, r) {
		let i = super.interpolate_(e, t, n, r);
		return Qe.fromArray(i).normalize().toArray(i), i;
	}
}, H = {
	FLOAT: 5126,
	FLOAT_MAT3: 35675,
...
function at(e) {
	let t, n = e.extensions && e.extensions[I.KHR_DRACO_MESH_COMPRESSION];
	if (t = n ? "draco:" + n.bufferView + ":" + n.indices + ":" + Z(n.attributes) : e.indices + ":" + Z(e.attributes) + ":" + e.mode, e.targets !== void 0) for (let n = 0, r = e.targets.length; n < r; n++) t += ":" + Z(e.targets[n]);
	return t;
}
function Z(e) {
...
var st = new M(), ct = class {
	constructor(e = {}, n = {}) {
		this.json = e, this.extensions = {}, this.plugins = {}, this.options = n, this.cache = new Ae(), this.associations = /* @__PURE__ */ new Map(), this.primitiveCache = {}, this.nodeCache = {}, this.meshCache = {
			refs: {},
			uses: {}
		}, this.cameraCache = {
			refs: {},
		...
		if (typeof navigator < "u" && navigator.userAgent !== void 0) {
			...
			i = /^((?!chrome|android).)*safari/i.test(e) === !0;
			let t = e.match(/Version\/(\d+)/);
			a = i && t ? parseInt(t[1], 10) : -1, o = e.indexOf("Firefox") > -1, s = o ? e.match(/Firefox\/([0-9]+)\./)[1] : -1;
		}
		typeof createImageBitmap > "u" || i && a < 17 || o && s < 98 ? this.textureLoader = new r(this.options.manager) : this.textureLoader = new t(this.options.manager), this.textureLoader.setCrossOrigin(this.options.crossOrigin), this.textureLoader.setRequestHeader(this.options.requestHeader), this.fileLoader = new u(this.options.manager), this.fileLoader.setResponseType("arraybuffer"), this.options.crossOrigin === "use-credentials" && this.fileLoader.setWithCredentials(!0);
	}
	setExtensions(e) {
		this.extensions = e;
	}
	...
	parse(e, t) {
		...
		this.cache.removeAll(), this.nodeCache = {}, this._invokeAll(function(e) {
			...
			return Y(i, a, r), X(a, r), Promise.all(n._invokeAll(function(e) {
	...
	loadBuffer(e) {
		...
		if (t.uri === void 0 && e === 0) return Promise.resolve(this.extensions[I.KHR_BINARY_GLTF].body);
		let r = this.options;
		return new Promise(function(e, i) {
			n.load(g.resolveURL(t.uri, r.path), e, void 0, function() {
	...
	loadAccessor(e) {
		...
		if (i.bufferView === void 0 && i.sparse === void 0) {
			let e = G[i.type], t = U[i.componentType], r = i.normalized === !0, a = new t(i.count * e);
		...
		return i.bufferView === void 0 ? a.push(null) : a.push(this.getDependency("bufferView", i.bufferView)), i.sparse !== void 0 && (a.push(this.getDependency("bufferView", i.sparse.indices.bufferView)), a.push(this.getDependency("bufferView", i.sparse.values.bufferView))), Promise.all(a).then(function(e) {
			let a = e[0], o = G[i.type], s = U[i.componentType], c = s.BYTES_PER_ELEMENT, l = c * o, u = i.byteOffset || 0, d = i.bufferView === void 0 ? void 0 : r.bufferViews[i.bufferView].byteStride, f = i.normalized === !0, p, m;
			if (d && d !== l) {
				let e = Math.floor(u / d), n = "InterleavedBuffer:" + i.bufferView + ":" + i.componentType + ":" + e + ":" + i.count, r = t.cache.get(n);
				r || (p = new s(a, e * d, i.count * d / c), r = new de(p, d / c), t.cache.add(n, r)), m = new Ce(r, o, u % d / c, f);
			} else p = a === null ? new s(i.count * o) : new s(a, u, i.count * o), m = new n(p, o, f);
			if (i.sparse !== void 0) {
				let t = G.SCALAR, r = U[i.sparse.indices.componentType], c = i.sparse.indices.byteOffset || 0, l = i.sparse.values.byteOffset || 0, u = new r(e[1], c, i.sparse.count * t), d = new s(e[2], l, i.sparse.count * o);
				a !== null && (m = new n(m.array.slice(), m.itemSize, m.normalized)), m.normalized = !1;
				for (let e = 0, t = u.length; e < t; e++) {
					let t = u[e];
					if (m.setX(t, d[e * o]), o >= 2 && m.setY(t, d[e * o + 1]), o >= 3 && m.setZ(t, d[e * o + 2]), o >= 4 && m.setW(t, d[e * o + 3]), o >= 5) throw Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.");
				}
				m.normalized = f;
			}
			return m;
	...
	loadTextureImage(e, t, n) {
		...
		let c = this.loadImageSource(t, n).then(function(t) {
			...
			return t.magFilter = W[n.magFilter] || 1006, t.minFilter = W[n.minFilter] || 1008, t.wrapS = et[n.wrapS] || 1e3, t.wrapT = et[n.wrapT] || 1e3, t.generateMipmaps = !t.isCompressedTexture && t.minFilter !== 1003 && t.minFilter !== 1006, r.associations.set(t, { textures: e }), t;
		}).catch(function() {
			return null;
		});
		...
		let l = Promise.resolve(s).then(function(e) {
			return new Promise(function(n, r) {
				...
				t.isImageBitmapLoader === !0 && (a = function(e) {
					let t = new O(e);
					t.needsUpdate = !0, n(t);
				}), t.load(g.resolveURL(e, i.path), a, void 0, r);
			});
		}).then(function(e) {
			return c === !0 && o.revokeObjectURL(s), X(e, a), e.userData.mimeType = a.mimeType || ot(a.uri), e;
		}).catch(function(e) {
	...
	assignTexture(e, t, n, r) {
		...
		return this.getDependency("texture", n.index).then(function(a) {
			if (!a) return null;
			if (n.texCoord !== void 0 && n.texCoord > 0 && (a = a.clone(), a.channel = n.texCoord), i.extensions[I.KHR_TEXTURE_TRANSFORM]) {
				let e = n.extensions === void 0 ? void 0 : n.extensions[I.KHR_TEXTURE_TRANSFORM];
				if (e) {
					let t = i.associations.get(a);
					a = i.extensions[I.KHR_TEXTURE_TRANSFORM].extendTexture(a, e), i.associations.set(a, t);
				}
			}
	...
	assignFinalMaterial(e) {
		...
		if (e.isPoints) {
			...
			t || (t = new l(), v.prototype.copy.call(t, n), t.color.copy(n.color), t.map = n.map, t.sizeAttenuation = !1, this.cache.add(e, t)), n = t;
		} else if (e.isLine) {
			let e = "LineBasicMaterial:" + n.uuid, t = this.cache.get(e);
			t || (t = new ye(), v.prototype.copy.call(t, n), t.color.copy(n.color), t.map = n.map, this.cache.add(e, t)), n = t;
		}
		if (r || i || a) {
	...
	loadMaterial(t) {
		let n = this, r = this.json, i = this.extensions, a = r.materials[t], o, s = {}, c = a.extensions || {}, l = [];
		if (c[I.KHR_MATERIALS_UNLIT]) {
			let e = i[I.KHR_MATERIALS_UNLIT];
			o = e.getMaterialType(), l.push(e.extendParams(s, a, n));
		} else {
			let e = a.pbrMetallicRoughness || {};
			if (s.color = new y(1, 1, 1), s.opacity = 1, Array.isArray(e.baseColorFactor)) {
				let t = e.baseColorFactor;
				s.color.setRGB(t[0], t[1], t[2], b), s.opacity = t[3];
			}
			e.baseColorTexture !== void 0 && l.push(n.assignTexture(s, "map", e.baseColorTexture, C)), s.metalness = e.metallicFactor === void 0 ? 1 : e.metallicFactor, s.roughness = e.roughnessFactor === void 0 ? 1 : e.roughnessFactor, e.metallicRoughnessTexture !== void 0 && (l.push(n.assignTexture(s, "metalnessMap", e.metallicRoughnessTexture)), l.push(n.assignTexture(s, "roughnessMap", e.metallicRoughnessTexture))), o = this._invokeOne(function(e) {
		...
		let u = a.alphaMode || J.OPAQUE;
		if (u === J.BLEND ? (s.transparent = !0, s.depthWrite = !1) : (s.transparent = !1, u === J.MASK && (s.alphaTest = a.alphaCutoff === void 0 ? .5 : a.alphaCutoff)), a.normalTexture !== void 0 && o !== T && (l.push(n.assignTexture(s, "normalMap", a.normalTexture)), s.normalScale = new e(1, 1), a.normalTexture.scale !== void 0)) {
			let e = a.normalTexture.scale;
			s.normalScale.set(e, e);
		}
		if (a.occlusionTexture !== void 0 && o !== T && (l.push(n.assignTexture(s, "aoMap", a.occlusionTexture)), a.occlusionTexture.strength !== void 0 && (s.aoMapIntensity = a.occlusionTexture.strength)), a.emissiveFactor !== void 0 && o !== T) {
			let e = a.emissiveFactor;
			s.emissive = new y().setRGB(e[0], e[1], e[2], b);
		}
		return a.emissiveTexture !== void 0 && o !== T && l.push(n.assignTexture(s, "emissiveMap", a.emissiveTexture, C)), Promise.all(l).then(function() {
			let e = new o(s);
			return a.name && (e.name = a.name), X(e, a), n.associations.set(e, { materials: t }), a.extensions && Y(i, e, a), e;
		});
	}
	createUniqueName(e) {
		let t = De.sanitizeNodeName(e || "");
		return t in this.nodeNamesUsed ? t + "_" + ++this.nodeNamesUsed[t] : (this.nodeNamesUsed[t] = 0, t);
	}
	loadGeometries(e) {
		let t = this, n = this.extensions, r = this.primitiveCache;
		function i(e) {
			return n[I.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(e, t).then(function(n) {
				return $(n, e, t);
			});
		}
		let a = [];
		for (let n = 0, o = e.length; n < o; n++) {
			let o = e[n], s = at(o), c = r[s];
			if (c) a.push(c.promise);
			else {
				let e;
				e = o.extensions && o.extensions[I.KHR_DRACO_MESH_COMPRESSION] ? i(o) : $(new ve(), o, t), r[s] = {
					primitive: o,
					promise: e
				}, a.push(e);
			}
	...
	loadMesh(e) {
		...
		for (let e = 0, t = a.length; e < t; e++) {
			let t = a[e].material === void 0 ? nt(this.cache) : this.getDependency("material", a[e].material);
			o.push(t);
		}
		return o.push(t.loadGeometries(a)), Promise.all(o).then(function(n) {
			let o = n.slice(0, n.length - 1), s = n[n.length - 1], l = [];
			for (let n = 0, u = s.length; n < u; n++) {
				let u = s[n], d = a[n], f, p = o[n];
				if (d.mode === H.TRIANGLES || d.mode === H.TRIANGLE_STRIP || d.mode === H.TRIANGLE_FAN || d.mode === void 0) f = i.isSkinnedMesh === !0 ? new le(u, p) : new _e(u, p), f.isSkinnedMesh === !0 && f.normalizeSkinWeights(), d.mode === H.TRIANGLE_STRIP ? f.geometry = N(f.geometry, 1) : d.mode === H.TRIANGLE_FAN && (f.geometry = N(f.geometry, 2));
				else if (d.mode === H.LINES) f = new h(u, p);
				else if (d.mode === H.LINE_STRIP) f = new be(u, p);
				else if (d.mode === H.LINE_LOOP) f = new c(u, p);
				else if (d.mode === H.POINTS) f = new ne(u, p);
				else throw Error("THREE.GLTFLoader: Primitive mode unsupported: " + d.mode);
				Object.keys(f.geometry.morphAttributes).length > 0 && it(f, i), f.name = t.createUniqueName(i.name || "mesh_" + e), X(f, i), d.extensions && Y(r, f, d), t.assignFinalMaterial(f), l.push(f);
			}
			for (let n = 0, r = l.length; n < r; n++) t.associations.set(l[n], {
				meshes: e,
				primitives: n
			});
			if (l.length === 1) return i.extensions && Y(r, l[0], i), l[0];
			let u = new j();
			i.extensions && Y(r, u, i), t.associations.set(u, { meshes: e });
	...
	loadCamera(e) {
		...
		return n.type === "perspective" ? t = new te(ue.radToDeg(r.yfov), r.aspectRatio || 1, r.znear || 1, r.zfar || 2e6) : n.type === "orthographic" && (t = new s(-r.xmag, r.xmag, r.ymag, -r.ymag, r.znear, r.zfar)), n.name && (t.name = this.createUniqueName(n.name)), X(t, n), Promise.resolve(t);
	}
	loadSkin(e) {
	...
	loadNode(e) {
		...
		return Promise.all([
			...
			r !== null && t.traverse(function(e) {
				e.isSkinnedMesh && e.bind(r, st);
			});
			for (let e = 0, r = n.length; e < r; e++) t.add(n[e]);
			if (t.userData.pivot !== void 0 && n.length > 0) {
				let e = t.userData.pivot, r = n[0];
				t.pivot = new E().fromArray(e), t.position.x -= e[0], t.position.y -= e[1], t.position.z -= e[2], r.position.set(0, 0, 0), delete t.userData.pivot;
			}
			return t;
		});
	}
	_loadNodeShallow(e) {
		...
		let o = t.nodes[e], s = o.name ? r.createUniqueName(o.name) : "", c = [], l = r._invokeOne(function(t) {
			return t.createNodeMesh && t.createNodeMesh(e);
		});
		return l && c.push(l), o.camera !== void 0 && c.push(r.getDependency("camera", o.camera).then(function(e) {
			...
			let c;
			if (c = o.isBone === !0 ? new i() : t.length > 1 ? new j() : t.length === 1 ? t[0] : new a(), c !== t[0]) for (let e = 0, n = t.length; e < n; e++) c.add(t[e]);
			if (o.name && (c.userData.name = o.name, c.name = s), X(c, o), o.extensions && Y(n, c, o), o.matrix !== void 0) {
				let e = new M();
				e.fromArray(o.matrix), c.applyMatrix4(e);
			...
			if (!r.associations.has(c)) r.associations.set(c, {});
				...
				let e = r.associations.get(c);
				r.associations.set(c, { ...e });
			}
			return r.associations.get(c).nodes = e, c;
		}), this.nodeCache[e];
	}
	loadScene(e) {
		let t = this.extensions, n = this.json.scenes[e], r = this, i = new j();
		n.name && (i.name = r.createUniqueName(n.name)), X(i, n), n.extensions && Y(t, i, n);
		let a = n.nodes || [], o = [];
		for (let e = 0, t = a.length; e < t; e++) o.push(r.getDependency("node", a[e]));
		return Promise.all(o).then(function(e) {
			for (let t = 0, n = e.length; t < n; t++) {
				let n = e[t];
				n.parent === null ? i.add(n) : i.add(Oe(n));
			}
			return r.associations = ((e) => {
				let t = /* @__PURE__ */ new Map();
				for (let [e, n] of r.associations) (e instanceof v || e instanceof O) && t.set(e, n);
				return e.traverse((e) => {
	...
	_createAnimationTracks(e, t, n, r, i) {
		...
		q[i.path] === q.weights ? (c(e), e.isGroup && e.children.forEach(c)) : s.push(o);
		let l;
		switch (q[i.path]) {
			case q.weights:
				l = re;
		...
		let u = r.interpolation === void 0 ? w : tt[r.interpolation], d = this._getArrayFromAccessor(n);
		for (let e = 0, n = s.length; e < n; e++) {
			let n = new l(s[e] + "." + q[i.path], t.array, d, u);
	...
	_getArrayFromAccessor(e) {
		let t = e.array;
		if (e.normalized) {
			let e = Q(t.constructor), n = new Float32Array(t.length);
	...
	_createCubicSplineTrackInterpolant(e) {
		e.createInterpolant = function(e) {
			return new (this instanceof S ? $e : V)(this.times, this.values, this.getValueSize() / 3, e);
		}, e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline = !0;
	}
};
function lt(e, t, n) {
	let r = t.attributes, i = new o();
	if (r.POSITION !== void 0) {
		let e = n.json.accessors[r.POSITION], t = e.min, a = e.max;
		if (t !== void 0 && a !== void 0) {
			if (i.set(new E(t[0], t[1], t[2]), new E(a[0], a[1], a[2])), e.normalized) {
				let t = Q(U[e.componentType]);
...
function $(e, t, n) {
	...
	return d.workingColorSpace !== "srgb-linear" && "COLOR_0" in r && console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${d.workingColorSpace}" not supported.`), X(e, t), lt(e, t, n), Promise.all(i).then(function() {
		return t.targets === void 0 ? e : rt(e, t.targets, n);
	});
}
//#endregion
export { ke as GLTFLoader };
